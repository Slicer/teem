...
teem/{lib}.h, generated by build_teem.py to declare the {lib}
library contents to CFFI, within its many limitations, specifically lacking
a C pre-processor (so no #include directives, and only certain #defines). */
 """
            )
