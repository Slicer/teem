...
teem/echo.h, generated by build_teem.py to declare the echo
...
**
** all the "real" objects have a unsigned char matter; echoCol_t rgba[4]; echoCol_t mat[ECHO_MATTER_PARM_NUM]; Nrrd *ntext following type
*/
typedef struct {
  signed char type;
  unsigned char matter; echoCol_t rgba[4]; echoCol_t mat[ECHO_MATTER_PARM_NUM]; Nrrd *ntext; /* ha! its not actually in every object, but in
...
/* enumsEcho.c ------------------------------------------ */
extern const airEnum *const echoJitter;
extern const airEnum *const echoType;
extern const airEnum *const echoMatter;
/* methodsEcho.c --------------------------------------- */
extern const int echoPresent;
extern const char *const echoBiffKey;
extern echoRTParm *echoRTParmNew(void);
extern echoRTParm *echoRTParmNix(echoRTParm *parm);
extern echoGlobalState *echoGlobalStateNew(void);
extern echoGlobalState *echoGlobalStateNix(echoGlobalState *state);
extern echoThreadState *echoThreadStateNew(void);
extern echoThreadState *echoThreadStateNix(echoThreadState *state);
extern echoScene *echoSceneNew(void);
...
extern echoObject *echoListSplit(echoScene *scene, echoObject *list, int axis);
extern echoObject *echoListSplit3(echoScene *scene, echoObject *list, int depth);
/* set.c --------------------------------------- */
extern void echoSphereSet(echoObject *sphere, echoPos_t x, echoPos_t y, echoPos_t z,
                               echoPos_t rad);
extern void echoCylinderSet(echoObject *cylind, int axis);
extern void echoSuperquadSet(echoObject *squad, int axis, echoPos_t A, echoPos_t B);
extern void echoRectangleSet(echoObject *rect, echoPos_t ogx, echoPos_t ogy,
                                  echoPos_t ogz, echoPos_t x0, echoPos_t y0,
                                  echoPos_t z0, echoPos_t x1, echoPos_t y1,
                                  echoPos_t z1);
extern void echoTriangleSet(echoObject *tri, echoPos_t x0, echoPos_t y0,
                                 echoPos_t z0, echoPos_t x1, echoPos_t y1, echoPos_t z1,
                                 echoPos_t x2, echoPos_t y2, echoPos_t z2);
extern void echoTriMeshSet(echoObject *trim, int numV, echoPos_t *pos, int numF,
                                int *vert);
extern void echoInstanceSet(echoObject *inst, echoPos_t *M, echoObject *obj);
/* matter.c ------------------------------------------ */
extern const int echoObjectHasMatter[ECHO_TYPE_NUM];
extern void echoColorSet(echoObject *obj, echoCol_t R, echoCol_t G, echoCol_t B,
                              echoCol_t A);
extern void echoMatterPhongSet(echoScene *scene, echoObject *obj, echoCol_t ka,
                                    echoCol_t kd, echoCol_t ks, echoCol_t sp);
extern void echoMatterGlassSet(echoScene *scene, echoObject *obj, echoCol_t index,
                                    echoCol_t ka, echoCol_t kd, echoCol_t fuzzy);
extern void echoMatterMetalSet(echoScene *scene, echoObject *obj, echoCol_t R0,
                                    echoCol_t ka, echoCol_t kd, echoCol_t fuzzy);
extern void echoMatterLightSet(echoScene *scene, echoObject *obj, echoCol_t power,
                                    echoCol_t unit);
extern void echoMatterTextureSet(echoScene *scene, echoObject *obj, Nrrd *ntext);
/* lightEcho.c ------------------------------------------- */
extern void echoLightPosition(echoPos_t pos[3], echoObject *light,
                                   echoThreadState *tstate);
extern void echoLightColor(echoCol_t rgb[3], echoPos_t Ldist, echoObject *light,
                                echoRTParm *parm, echoThreadState *tstate);
extern void echoEnvmapLookup(echoCol_t rgb[3], echoPos_t norm[3], Nrrd *envmap);
/* color.c ------------------------------------------- */
extern void echoTextureLookup(echoCol_t rgba[4], Nrrd *ntext, echoPos_t u,
...
extern int echoRayIntx(echoIntx *intx, echoRay *ray, echoScene *scene,
                            echoRTParm *parm, echoThreadState *tstate);
extern void echoIntxColor(echoCol_t rgba[4], echoIntx *intx, echoScene *scene,
                               echoRTParm *parm, echoThreadState *tstate);
/* renderEcho.c ---------------------------------------- */
extern int echoThreadStateInit(int threadIdx, echoThreadState *tstate,
                                    echoRTParm *parm, echoGlobalState *gstate);
extern void echoJitterCompute(echoRTParm *parm, echoThreadState *state);
extern void echoRayColor(echoCol_t rgba[4], echoRay *ray, echoScene *scene,
                              echoRTParm *parm, echoThreadState *tstate);
extern void echoChannelAverage(echoCol_t *img, echoRTParm *parm,
                                    echoThreadState *tstate);
