...
teem/mite.h, generated by build_teem.py to declare the mite
...
/* defaultsMite.c */
extern const int mitePresent;
extern const char *const miteBiffKey;
extern double miteDefRefStep;
extern int miteDefRenorm;
extern int miteDefNormalSide;
extern double miteDefOpacNear1;
extern double miteDefOpacMatters;
/* kindnot.c */
extern const airEnum *const miteVal;
extern const gageKind *const miteValGageKind;
/* txf.c */
extern const airEnum *const miteStageOp;
extern const char *const miteRangeChar;
extern int miteVariableParse(gageItemSpec *isp, const char *label);
extern void miteVariablePrint(char *buff, const gageItemSpec *isp);
extern int miteNtxfCheck(const Nrrd *ntxf);
extern void miteQueryAdd(gageQuery queryScl, gageQuery queryVec, gageQuery queryTen,
                              gageQuery queryMite, gageItemSpec *isp);
/* user.c */
extern miteUser *miteUserNew(void);
extern miteUser *miteUserNix(miteUser *muu);
/* shade.c */
extern miteShadeSpec *miteShadeSpecNew(void);
extern miteShadeSpec *miteShadeSpecNix(miteShadeSpec *);
extern int miteShadeSpecParse(miteShadeSpec *shpec, char *shadeStr);
extern void miteShadeSpecPrint(char *buff, const miteShadeSpec *shpec);
extern void miteShadeSpecQueryAdd(gageQuery queryScl, gageQuery queryVec,
...
/* thread.c */
extern miteThread *miteThreadNew(void);
extern miteThread *miteThreadNix(miteThread *mtt);
...
/* ray.c */
extern int miteRayBegin(miteThread *mtt, miteRender *mrr, miteUser *muu, int uIndex,
                             int vIndex, double rayLen, double rayStartWorld[3],
                             double rayStartIndex[3], double rayDirWorld[3],
                             double rayDirIndex[3]);
extern double miteSample(miteThread *mtt, miteRender *mrr, miteUser *muu, int num,
                              double rayT, int inside, double samplePosWorld[3],
                              double samplePosIndex[3]);
extern int miteRayEnd(miteThread *mtt, miteRender *mrr, miteUser *muu);
