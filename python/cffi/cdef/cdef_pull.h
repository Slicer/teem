...
teem/pull.h, generated by build_teem.py to declare the pull
...
/* defaultsPull.c */
extern const int pullPresent;
extern const int pullPhistEnabled;
extern const char *const pullBiffKey;
/* initPull.c */
extern int pullInitRandomSet(pullContext *pctx, unsigned int numInitial);
extern int pullInitHaltonSet(pullContext *pctx, unsigned int numInitial,
                                  unsigned int start);
extern int pullInitPointPerVoxelSet(pullContext *pctx, int pointPerVoxel,
                                         unsigned int zSlcMin, unsigned int zSlcMax,
                                         unsigned int alongScaleNum, double jitter);
extern int pullInitGivenPosSet(pullContext *pctx, const Nrrd *npos);
extern int pullInitLiveThreshUseSet(pullContext *pctx, int liveThreshUse);
extern int pullInitUnequalShapesAllowSet(pullContext *pctx, int allow);
/* parmPull.c */
extern int pullIterParmSet(pullContext *pctx, int which, unsigned int pval);
extern int pullSysParmSet(pullContext *pctx, int which, double pval);
extern int pullFlagSet(pullContext *pctx, int which, int flag);
extern int pullVerboseSet(pullContext *pctx, int verbose);
extern int pullThreadNumSet(pullContext *pctx, unsigned int threadNum);
extern int pullRngSeedSet(pullContext *pctx, unsigned int rngSeed);
extern int pullProgressBinModSet(pullContext *pctx, unsigned int bmod);
extern int pullCallbackSet(pullContext *pctx,
                                void (*iter_cb)(void *data_cb),
                                void *data_cb);
extern int pullInterEnergySet(pullContext *pctx, int interType,
                                   const pullEnergySpec *enspR,
                                   const pullEnergySpec *enspS,
                                   const pullEnergySpec *enspWin);
extern int pullLogAddSet(pullContext *pctx, FILE *log);
/* energy.c */
extern const airEnum *const pullInterType;
extern const airEnum *const pullEnergyType;
extern const pullEnergy *const pullEnergyUnknown;
extern const pullEnergy *const pullEnergySpring;
extern const pullEnergy *const pullEnergyGauss;
extern const pullEnergy *const pullEnergyBspln;
extern const pullEnergy *const pullEnergyButterworth;
extern const pullEnergy *const pullEnergyCotan;
extern const pullEnergy *const pullEnergyCubic;
extern const pullEnergy *const pullEnergyQuartic;
extern const pullEnergy *const pullEnergyCubicWell;
extern const pullEnergy *const pullEnergyBetterCubicWell;
extern const pullEnergy *const pullEnergyQuarticWell;
extern const pullEnergy *const pullEnergyHepticWell;
extern const pullEnergy *const pullEnergyZero;
extern const pullEnergy *const pullEnergyButterworthParabola;
extern const pullEnergy *const pullEnergyAll[PULL_ENERGY_TYPE_MAX + 1];
extern pullEnergySpec *pullEnergySpecNew(void);
extern void pullEnergySpecSet(pullEnergySpec *ensp,
                                   const pullEnergy *energy,
                                   const double parm[PULL_ENERGY_PARM_NUM]);
extern void pullEnergySpecCopy(pullEnergySpec *esDst, const pullEnergySpec *esSrc);
extern pullEnergySpec *pullEnergySpecNix(pullEnergySpec *ensp);
extern int pullEnergySpecParse(pullEnergySpec *ensp, const char *str);
extern const hestCB *const pullHestEnergySpec;
/* volumePull.c */
extern pullVolume *pullVolumeNew(void);
extern pullVolume *pullVolumeNix(pullVolume *vol);
extern int pullVolumeSingleAdd(pullContext *pctx, const gageKind *kind, char *name,
                                    const Nrrd *nin, const NrrdKernelSpec *ksp00,
                                    const NrrdKernelSpec *ksp11,
                                    const NrrdKernelSpec *ksp22);
extern int pullVolumeStackAdd(pullContext *pctx,
                                   const gageKind *kind,
                                   char *name,
                                   const Nrrd *nin,
...
extern const pullVolume *pullVolumeLookup(const pullContext *pctx,
                                               const char *volName);
extern int pullConstraintScaleRange(pullContext *pctx, double ssrange[2]);
/* enumsPull.c */
extern const airEnum *const pullInfo;
extern const airEnum *const pullSource;
extern const airEnum *const pullProp;
extern const airEnum *const pullProcessMode;
extern const airEnum *const pullTraceStop;
extern const airEnum *const pullInitMethod;
extern const airEnum *const pullCount;
extern const airEnum *const pullConstraintFail;
/* infoPull.c */
extern unsigned int pullPropLen(int prop);
extern unsigned int pullInfoLen(int info);
extern pullInfoSpec *pullInfoSpecNew(void);
...
/* contextPull.c */
extern pullContext *pullContextNew(void);
extern pullContext *pullContextNix(pullContext *pctx);
extern int pullOutputGet(Nrrd *nPosOut, Nrrd *nTenOut, Nrrd *nStrengthOut,
                              const double scaleVec[3], double scaleRad,
                              pullContext *pctx);
extern int pullOutputGetFilter(Nrrd *nPosOut, Nrrd *nTenOut, Nrrd *nStrengthOut,
                                    const double scaleVec[3], double scaleRad,
                                    pullContext *pctx, unsigned int idtagMin,
                                    unsigned int idtagMax);
extern int pullPositionHistoryPolydataGet(limnPolyData *pld, pullContext *pctx);
extern int pullPositionHistoryNrrdGet(Nrrd *nhist, pullContext *pctx,
                                           pullPoint *point);
extern int pullPropGet(Nrrd *nprop, int prop, pullContext *pctx);
/* pointPull.c */
extern int pullPointInitializePerVoxel(const pullContext *pctx,
                                            const unsigned int pointIdx,
                                            pullPoint *point,
                                            pullVolume *scaleVol,
                                            int *createFailP);
extern int pullPointInitializeRandomOrHalton(pullContext *pctx,
                                                  const unsigned int pointIdx,
                                                  pullPoint *point,
                                                  pullVolume *scaleVol);
extern int pullPointInitializeGivenPos(pullContext *pctx,
...
extern unsigned int pullPointNumberFilter(const pullContext *pctx,
                                               ...
                                               unsigned int idtagMax);
extern pullPoint *pullPointNew(pullContext *pctx);
extern pullPoint *pullPointNix(pullPoint *pnt);
extern int pullProbe(pullTask *task, pullPoint *point);
/* binningPull.c */
extern int pullBinsPointAdd(pullContext *pctx, pullPoint *point,
                                 /* output */
                                 pullBin **binUsed);
extern int pullBinsPointMaybeAdd(pullContext *pctx, pullPoint *point,
                                      /* output */
                                      pullBin **binUsed, int *added);
/* trace.c */
extern pullTrace *pullTraceNew(void);
extern pullTrace *pullTraceNix(pullTrace *pts);
extern size_t pullTraceMultiSizeof(const pullTraceMulti *mtrc);
extern void pullTraceStability(double *spcStab,
                                    double *oriStab,
                                    const double pos0[4],
                                    const double pos1[4],
                                    const double ori0[3],
                                    ...
                                    double sigma0,
                                    const pullContext *pctx);
extern int pullTraceSet(pullContext *pctx, pullTrace *trc, int recordStrength,
                             double scaleDelta, double halfScaleWin,
                             double orientTestLen, unsigned int arrIncr,
                             const double seedPos[4]);
extern pullTraceMulti *pullTraceMultiNew(void);
extern pullTraceMulti *pullTraceMultiNix(pullTraceMulti *mtrc);
extern int pullTraceMultiAdd(pullTraceMulti *mtrc, pullTrace *trc, int *addedP);
...
/* PULL_EXPORT int pullTraceMultiFilterConcaveDown(Nrrd *nfilt,
                                                ...
                                                double winLenFrac); */
extern int pullTraceMultiPlotAdd(Nrrd *nplot, const pullTraceMulti *mtrc,
                                      const Nrrd *nfilt, int strengthUse, int smooth,
                                      int flatWght, unsigned int trcIdxMin,
                                      unsigned int trcNum, Nrrd *nmaskedpos,
                                      const Nrrd *nmask);
extern int pullTraceMultiWrite(FILE *file, const pullTraceMulti *mtrc);
extern int pullTraceMultiRead(pullTraceMulti *mtrc, FILE *file);
/* actionPull.c */
extern int pullEnergyPlot(pullContext *pctx, Nrrd *nplot, double xx, double yy,
                               double zz, unsigned int res);
extern int pullBinProcess(pullTask *task, unsigned int myBinIdx);
extern int pullGammaLearn(pullContext *pctx);
/* corePull.c */
extern int pullStart(pullContext *pctx);
extern int pullRun(pullContext *pctx);
extern int pullFinish(pullContext *pctx);
/* ccPull.c */
extern int pullCCFind(pullContext *pctx);
extern int pullCCMeasure(pullContext *pctx, Nrrd *nmeas, int measrInfo, double rho);
extern int pullCCSort(pullContext *pctx, int measrInfo, double rho);
