...
teem/ten.h, generated by build_teem.py to declare the ten
...
/* defaultsTen.c */
extern const int tenPresent;
extern const char *const tenBiffKey;
extern const char tenDefFiberKernel[];
extern double tenDefFiberStepSize;
extern int tenDefFiberUseIndexSpace;
extern int tenDefFiberMaxNumSteps;
extern double tenDefFiberMaxHalfLen;
extern int tenDefFiberAnisoStopType;
extern double tenDefFiberAnisoThresh;
extern int tenDefFiberIntg;
extern double tenDefFiberWPunct;
/* triple.c */
extern void tenTripleConvertSingle_d(double dst[3],
                                         int dstType,
                                         const double src[3],
                                         const int srcType);
extern void tenTripleConvertSingle_f(float dst[3],
                                         int dstType,
                                         const float src[3],
                                         const int srcType);
extern void tenTripleCalcSingle_d(double dst[3], int ttype, double ten[7]);
extern void tenTripleCalcSingle_f(float dst[3], int ttype, float ten[7]);
extern int tenTripleCalc(Nrrd *nout, int ttype, const Nrrd *nten);
extern int tenTripleConvert(Nrrd *nout, int dstType, const Nrrd *nin, int srcType);
/* grads.c */
extern tenGradientParm *tenGradientParmNew(void);
extern tenGradientParm *tenGradientParmNix(tenGradientParm *tgparm);
extern int tenGradientCheck(const Nrrd *ngrad, int type, unsigned int minnum);
extern int tenGradientRandom(Nrrd *ngrad, unsigned int num, unsigned int seed);
extern double tenGradientIdealEdge(unsigned int N, int single);
extern int tenGradientJitter(Nrrd *nout, const Nrrd *nin, double dist);
extern int tenGradientBalance(Nrrd *nout, const Nrrd *nin, tenGradientParm *tgparm);
extern void tenGradientMeasure(double *pot, double *minAngle, double *minEdge,
                                   const Nrrd *npos, tenGradientParm *tgparm,
                                   int edgeNormalize);
extern int tenGradientDistribute(Nrrd *nout, const Nrrd *nin,
                                     tenGradientParm *tgparm);
extern int tenGradientGenerate(Nrrd *nout, unsigned int num,
                                   tenGradientParm *tgparm);
/* enumsTen.c */
extern const airEnum *const tenAniso;
extern const airEnum *const tenInterpType;
extern const airEnum *const tenGage;
extern const airEnum *const tenFiberType;
extern const airEnum *const tenDwiFiberType;
extern const airEnum *const tenFiberStop;
extern const airEnum *const tenFiberIntg;
extern const airEnum *const tenGlyphType;
extern const airEnum *const tenEstimate1Method;
extern const airEnum *const tenEstimate2Method;
extern const airEnum *const tenTripleType;
/* path.c */
extern tenInterpParm *tenInterpParmNew(void);
extern tenInterpParm *tenInterpParmCopy(tenInterpParm *tip);
extern int tenInterpParmBufferAlloc(tenInterpParm *tip, unsigned int num);
extern tenInterpParm *tenInterpParmNix(tenInterpParm *tip);
extern void tenInterpTwo_d(double oten[7], const double tenA[7],
                               const double tenB[7], int ptype, double aa,
                               tenInterpParm *tip);
extern int tenInterpN_d(double tenOut[7], const double *tenIn, const double *wght,
                            unsigned int num, int ptype, tenInterpParm *tip);
extern double tenInterpPathLength(Nrrd *npath, int doubleVerts, int fancy,
                                      int shape);
extern int tenInterpTwoDiscrete_d(Nrrd *nout, const double tenA[7],
                                      const double tenB[7], int ptype, unsigned int num,
                                      tenInterpParm *tip);
extern double tenInterpDistanceTwo_d(const double tenA[7], const double tenB[7],
                                         int ptype, tenInterpParm *tip);
extern int tenInterpMulti3D(Nrrd *nout, const Nrrd *const *nin, const double *wght,
                                unsigned int ninNum, int ptype, tenInterpParm *tip);
/* glyph.c */
extern tenGlyphParm *tenGlyphParmNew(void);
extern tenGlyphParm *tenGlyphParmNix(tenGlyphParm *parm);
extern int tenGlyphParmCheck(tenGlyphParm *parm, const Nrrd *nten, const Nrrd *npos,
                                 const Nrrd *nslc);
extern int tenGlyphGen(limnObject *glyphs, echoScene *scene, tenGlyphParm *parm,
                           const Nrrd *nten, const Nrrd *npos, const Nrrd *nslc);
extern unsigned int tenGlyphBqdZoneEval(const double eval[3]);
extern void tenGlyphBqdUvEval(double uv[2], const double eval[3]);
extern void tenGlyphBqdEvalUv(double eval[3], const double uv[2]);
extern unsigned int tenGlyphBqdZoneUv(const double uv[2]);
extern void tenGlyphBqdAbcUv(double abc[3], const double uv[2], double betaMax);
/* tensor.c */
extern int tenVerbose;
extern void tenRotateSingle_f(float tenOut[7], const float rot[9],
                                  const float tenIn[7]);
extern int tenTensorCheck(const Nrrd *nin, int wantType, int want4D, int useBiff);
extern int tenMeasurementFrameReduce(Nrrd *nout, const Nrrd *nin);
extern int tenExpand2D(Nrrd *nout, const Nrrd *nin, double scale, double thresh);
extern int tenExpand(Nrrd *tnine, const Nrrd *tseven, double scale, double thresh);
extern int tenShrink(Nrrd *tseven, const Nrrd *nconf, const Nrrd *tnine);
extern int tenEigensolve_f(float eval[3], float evec[9], const float ten[7]);
extern int tenEigensolve_d(double eval[3], double evec[9], const double ten[7]);
extern void tenMakeSingle_f(float ten[7], float conf, const float eval[3],
                                const float evec[9]);
extern void tenMakeSingle_d(double ten[7], double conf, const double eval[3],
                                const double evec[9]);
extern int tenMake(Nrrd *nout, const Nrrd *nconf, const Nrrd *neval,
                       const Nrrd *nevec);
extern int tenSlice(Nrrd *nout, const Nrrd *nten, unsigned int axis, size_t pos,
                        unsigned int dim);
extern void tenInvariantGradientsK_d(double K1[7],
                                         double K2[7],
                                         double K3[7],
                                         const double ten[7],
                                         const double minnorm);
extern void tenInvariantGradientsR_d(double R1[7],
                                         double R2[7],
                                         double R3[7],
                                         const double ten[7],
                                         const double minnorm);
extern void tenRotationTangents_d(double phi1[7],
                                      double phi2[7],
                                      double phi3[7],
                                      const double evec[9]);
extern void tenLogSingle_d(double logten[7], const double ten[7]);
extern void tenLogSingle_f(float logten[7], const float ten[7]);
extern void tenExpSingle_d(double expten[7], const double ten[7]);
extern void tenExpSingle_f(float expten[7], const float ten[7]);
extern void tenSqrtSingle_d(double sqrtten[7], const double ten[7]);
extern void tenSqrtSingle_f(float sqrtten[7], const float ten[7]);
extern void tenPowSingle_d(double powten[7], const double ten[7], double power);
extern void tenPowSingle_f(float powten[7], const float ten[7], float power);
/* should rename to tenInvSingle_x */
extern void tenInv_f(float inv[7], const float ten[7]);
extern void tenInv_d(double inv[7], const double ten[7]);
extern double tenDoubleContract_d(double a[7], double T[21], double b[7]);
/* chan.c */
/* old tenCalc* functions superceded/deprecated by new tenEstimate* code */
extern const char *const tenDWMRIModalityKey;
extern const char *const tenDWMRIModalityVal;
extern const char *const tenDWMRINAVal;
extern const char *const tenDWMRIBValueKey;
extern const char *const tenDWMRIGradKeyFmt;
extern const char *const tenDWMRIBmatKeyFmt;
extern const char *const tenDWMRINexKeyFmt;
extern const char *const tenDWMRISkipKeyFmt;
extern int tenDWMRIKeyValueParse(Nrrd **ngradP, Nrrd **nbmatP, double *bP,
                                     unsigned int **skip, unsigned int *skipNum,
                                     const Nrrd *ndwi);
extern int tenBMatrixCalc(Nrrd *nbmat, const Nrrd *ngrad);
extern int tenEMatrixCalc(Nrrd *nemat, const Nrrd *nbmat, int knownB0);
extern void tenEstimateLinearSingle_f(float *ten, float *B0P, const float *dwi,
                                          const double *emat, double *vbuf,
                                          unsigned int DD, int knownB0, float thresh,
                                          float soft, float b);
extern void tenEstimateLinearSingle_d(double *ten, double *B0P, const double *dwi,
                                          const double *emat, double *vbuf,
...
extern void tenSimulateSingle_f(float *dwi, float B0, const float *ten,
                                    const double *bmat, unsigned int DD, float b);
extern int tenSimulate(Nrrd *ndwi, const Nrrd *nT2, const Nrrd *nten,
                           const Nrrd *nbmat, double b);
/* estimate.c */
extern tenEstimateContext *tenEstimateContextNew(void);
extern void tenEstimateVerboseSet(tenEstimateContext *tec, int verbose);
extern void tenEstimateNegEvalShiftSet(tenEstimateContext *tec, int doit);
extern int tenEstimateMethodSet(tenEstimateContext *tec, int estMethod);
extern int tenEstimateSigmaSet(tenEstimateContext *tec, double sigma);
extern int tenEstimateValueMinSet(tenEstimateContext *tec, double valueMin);
extern int tenEstimateGradientsSet(tenEstimateContext *tec, const Nrrd *ngrad,
                                       double bValue, int estimateB0);
extern int tenEstimateBMatricesSet(tenEstimateContext *tec, const Nrrd *nbmat,
                                       double bValue, int estimateB0);
extern int tenEstimateSkipSet(tenEstimateContext *tec,
                                  unsigned int valIdx,
                                  int doSkip);
extern int tenEstimateSkipReset(tenEstimateContext *tec);
extern int tenEstimateThresholdFind(double *threshP, unsigned char *isB0,
                                        Nrrd *nin4d);
extern int tenEstimateThresholdSet(tenEstimateContext *tec, double thresh,
                                       double soft);
extern int tenEstimateUpdate(tenEstimateContext *tec);
extern int tenEstimate1TensorSimulateSingle_f(tenEstimateContext *tec, float *simval,
                                                  float sigma, float bValue, float B0,
                                                  const float _ten[7]);
extern int tenEstimate1TensorSimulateSingle_d(tenEstimateContext *tec,
                                                  double *simval, double sigma,
                                                  double bValue, double B0,
                                                  const double ten[7]);
extern int tenEstimate1TensorSimulateVolume(tenEstimateContext *tec, Nrrd *ndwi,
                                                double sigma, double bValue,
                                                const Nrrd *nB0, const Nrrd *nten,
                                                int outType, int keyValueSet);
extern int tenEstimate1TensorSingle_f(tenEstimateContext *tec, float ten[7],
                                          const float *all);
extern int tenEstimate1TensorSingle_d(tenEstimateContext *tec, double ten[7],
                                          const double *all);
extern int tenEstimate1TensorVolume4D(tenEstimateContext *tec, Nrrd *nten,
                                          Nrrd **nB0P, Nrrd **nterrP, const Nrrd *ndwi,
                                          int outType);
extern tenEstimateContext *tenEstimateContextNix(tenEstimateContext *tec);
/* aniso.c */
extern float (*const _tenAnisoEval_f[TEN_ANISO_MAX + 1])(const float eval[3]);
extern float tenAnisoEval_f(const float eval[3], int aniso);
extern double (*const _tenAnisoEval_d[TEN_ANISO_MAX + 1])(const double eval[3]);
extern double tenAnisoEval_d(const double eval[3], int aniso);
extern float (*const _tenAnisoTen_f[TEN_ANISO_MAX + 1])(const float ten[7]);
extern float tenAnisoTen_f(const float ten[7], int aniso);
extern double (*const _tenAnisoTen_d[TEN_ANISO_MAX + 1])(const double ten[7]);
extern double tenAnisoTen_d(const double ten[7], int aniso);
extern int tenAnisoPlot(Nrrd *nout, int aniso, unsigned int res, int hflip,
                            int whole, int nanout);
extern int tenAnisoVolume(Nrrd *nout, const Nrrd *nin, int aniso, double confThresh);
extern int tenAnisoHistogram(Nrrd *nout, const Nrrd *nin, const Nrrd *nwght,
                                 int right, int version, unsigned int resolution);
extern tenEvecRGBParm *tenEvecRGBParmNew(void);
extern tenEvecRGBParm *tenEvecRGBParmNix(tenEvecRGBParm *rgbp);
extern int tenEvecRGBParmCheck(const tenEvecRGBParm *rgbp);
extern void tenEvecRGBSingle_f(float RGB[3], float conf, const float eval[3],
                                   const float evec[3], const tenEvecRGBParm *rgbp);
extern void tenEvecRGBSingle_d(double RGB[3], double conf, const double eval[3],
                                   const double evec[3], const tenEvecRGBParm *rgbp);
/* miscTen.c */
extern int tenEvecRGB(Nrrd *nout, const Nrrd *nin, const tenEvecRGBParm *rgbp);
extern short tenEvqSingle_f(float vec[3], float scl);
extern int tenEvqVolume(Nrrd *nout, const Nrrd *nin, int which, int aniso,
                            int scaleByAniso);
extern int tenBMatrixCheck(const Nrrd *nbmat, int type, unsigned int minnum);
extern int _tenFindValley(double *valP, const Nrrd *nhist, double tweak, int save);
/* fiberMethods.c */
extern void tenFiberSingleInit(tenFiberSingle *tfbs);
extern void tenFiberSingleDone(tenFiberSingle *tfbs);
extern tenFiberSingle *tenFiberSingleNew(void);
extern tenFiberSingle *tenFiberSingleNix(tenFiberSingle *tfbs);
extern tenFiberContext *tenFiberContextNew(const Nrrd *dtvol);
extern tenFiberContext *tenFiberContextDwiNew(const Nrrd *dwivol,
                                                  double thresh,
                                                  double soft,
                                                  double valueMin,
                                                  int ten1method,
                                                  int ten2method);
extern void tenFiberVerboseSet(tenFiberContext *tfx, int verbose);
...
extern int tenFiberProbeItemSet(tenFiberContext *tfx, int item);
extern int tenFiberIntgSet(tenFiberContext *tfx, int intg);
extern int tenFiberStopSet(tenFiberContext *tfx, int stop, ...);
extern int tenFiberStopAnisoSet(tenFiberContext *tfx, int anisoType,
                                    double anisoThresh);
extern int tenFiberStopDoubleSet(tenFiberContext *tfx, int stop, double val);
extern int tenFiberStopUIntSet(tenFiberContext *tfx, int stop, unsigned int val);
extern void tenFiberStopOn(tenFiberContext *tfx, int stop);
extern void tenFiberStopOff(tenFiberContext *tfx, int stop);
extern void tenFiberStopReset(tenFiberContext *tfx);
extern int tenFiberAnisoSpeedSet(tenFiberContext *tfx, int aniso, double lerp,
                                     double thresh, double soft);
extern int tenFiberAnisoSpeedReset(tenFiberContext *tfx);
extern int tenFiberParmSet(tenFiberContext *tfx, int parm, double val);
extern int tenFiberUpdate(tenFiberContext *tfx);
extern tenFiberContext *tenFiberContextCopy(tenFiberContext *tfx);
extern tenFiberContext *tenFiberContextNix(tenFiberContext *tfx);
/* fiber.c */
extern int tenFiberTraceSet(tenFiberContext *tfx, Nrrd *nfiber, double *buff,
                                unsigned int halfBuffLen, unsigned int *startIdxP,
                                unsigned int *endIdxP, double seed[3]);
extern int tenFiberTrace(tenFiberContext *tfx, Nrrd *nfiber, double seed[3]);
extern unsigned int tenFiberDirectionNumber(tenFiberContext *tfx, double seed[3]);
extern int tenFiberSingleTrace(tenFiberContext *tfx, tenFiberSingle *tfbs,
                                   double seed[3], unsigned int which);
extern tenFiberMulti *tenFiberMultiNew(void);
extern tenFiberMulti *tenFiberMultiNix(tenFiberMulti *tfm);
extern int tenFiberMultiTrace(tenFiberContext *tfx, tenFiberMulti *tfml,
                                  const Nrrd *nseed);
extern int tenFiberMultiPolyData(tenFiberContext *tfx, limnPolyData *lpld,
                                     tenFiberMulti *tfml);
extern int tenFiberMultiProbeVals(tenFiberContext *tfx, Nrrd *nval,
                                      tenFiberMulti *tfml);
/* epireg.c */
extern int tenEpiRegister3D(Nrrd **nout, Nrrd **ndwi, unsigned int dwiLen,
                                ...
                                int verbose);
extern int tenEpiRegister4D(Nrrd *nout, Nrrd *nin, Nrrd *ngrad, int reference,
                                double bwX, double bwY, double fitFrac, double DWthr,
                                int doCC, const NrrdKernel *kern, double *kparm,
                                int progress, int verbose);
/* experSpec.c */
extern tenExperSpec *tenExperSpecNew(void);
extern int tenExperSpecGradSingleBValSet(tenExperSpec *espec,
                                             int insertB0,
                                             double bval,
                                             const double *grad,
                                             unsigned int gradNum);
extern int tenExperSpecGradBValSet(tenExperSpec *espec,
                                       int insertB0,
                                       const double *bval,
                                       const double *grad,
                                       unsigned int bgNum);
/* TEN_EXPORT int tenExperSpecGradBValWghtSet(tenExperSpec *espec,
                                           ...
                                           const double *wght,
                                           unsigned int bgwNum); */
extern int tenExperSpecFromKeyValueSet(tenExperSpec *espec, const Nrrd *ndwi);
extern tenExperSpec *tenExperSpecNix(tenExperSpec *espec);
extern double tenExperSpecKnownB0Get(const tenExperSpec *espec, const double *dwi);
extern double tenExperSpecMaxBGet(const tenExperSpec *espec);
extern int tenDWMRIKeyValueFromExperSpecSet(Nrrd *ndwi, const tenExperSpec *espec);
/* tenModel.c */
extern const char tenModelPrefixStr[];
extern int tenModelParse(const tenModel **model, int *plusB0, int requirePrefix,
                             const char *str);
extern int tenModelFromAxisLearnPossible(const NrrdAxisInfo *axinfo);
extern int tenModelFromAxisLearn(const tenModel **model, int *plusB0,
                                     const NrrdAxisInfo *axinfo);
extern int tenModelSimulate(Nrrd *ndwi, int typeOut, tenExperSpec *espec,
                                const tenModel *model, const Nrrd *nB0, /* maybe NULL */
                                const Nrrd *nparm, int keyValueSet);
extern int tenModelSqeFit(Nrrd *nparm, Nrrd **nsqeP, Nrrd **nconvP, Nrrd **niterP,
                              ...
                              int verbose);
extern int tenModelNllFit(Nrrd *nparm, Nrrd **nnllP, const tenModel *model,
                              const tenExperSpec *espec, const Nrrd *ndwi, int rician,
                              double sigma, int knownB0);
extern int tenModelConvert(Nrrd *nparmDst, int *convRet, const tenModel *modelDst,
...
*/
/* modelZero.c */
extern const tenModel *const tenModelZero;
/* modelB0.c */
extern const tenModel *const tenModelB0;
/* modelBall.c */
extern const tenModel *const tenModelBall;
/* model1Vector2D.c */
extern const tenModel *const tenModel1Vector2D;
/* model1Unit2D.c */
extern const tenModel *const tenModel1Unit2D;
/* model2Unit2D.c */
extern const tenModel *const tenModel2Unit2D;
/* model1Stick.c */
extern const tenModel *const tenModel1Stick;
/* modelBall1StickEMD.c */
extern const tenModel *const tenModelBall1StickEMD;
/* modelBall1Stick.c */
extern const tenModel *const tenModelBall1Stick;
/* modelBall1Cylinder.c */
extern const tenModel *const tenModelBall1Cylinder;
/* model1Cylinder.c */
extern const tenModel *const tenModel1Cylinder;
/* model1Tensor2.c: 2nd-order tensor (one of them), not two-tensor */
extern const tenModel *const tenModel1Tensor2;
/* mod.c */
extern int tenSizeNormalize(Nrrd *nout, const Nrrd *nin, double weight[3],
                                double amount, double target);
extern int tenSizeScale(Nrrd *nout, const Nrrd *nin, double amount);
extern int tenAnisoScale(Nrrd *nout, const Nrrd *nin, double scale, int fixDet,
                             int makePositive);
extern int tenEigenvaluePower(Nrrd *nout, const Nrrd *nin, double expo);
extern int tenEigenvalueClamp(Nrrd *nout, const Nrrd *nin, double min, double max);
extern int tenEigenvalueAdd(Nrrd *nout, const Nrrd *nin, double val);
extern int tenEigenvalueMultiply(Nrrd *nout, const Nrrd *nin, double val);
extern int tenLog(Nrrd *nout, const Nrrd *nin);
extern int tenExp(Nrrd *nout, const Nrrd *nin);
/* bvec.c */
extern int tenBVecNonLinearFit(Nrrd *nout, const Nrrd *nin, double *bb, double *ww,
                                   int iterMax, double eps);
/* tenGage.c */
extern gageKind *const tenGageKind;
/* tenDwiGage.c */
/* we can't declare or define a tenDwiGageKind->name (analogous to
   ...
   name (HEY: ugly) */
extern const airEnum *const tenDwiGage;
extern gageKind *tenDwiGageKindNew(void);
extern gageKind *tenDwiGageKindNix(gageKind *dwiKind);
/* warning: this function will likely change its arguments in the future */
extern int tenDwiGageKindSet(gageKind *dwiKind, double thresh, double soft,
                                 double bval, double valueMin, const Nrrd *ngrad,
                                 const Nrrd *nbmat, int emethod1, int emethod2,
                                 unsigned int randSeed);
extern int tenDwiGageKindCheck(const gageKind *kind);
/* bimod.c */
extern tenEMBimodalParm *tenEMBimodalParmNew(void);
extern tenEMBimodalParm *tenEMBimodalParmNix(tenEMBimodalParm *biparm);
extern int tenEMBimodal(tenEMBimodalParm *biparm, const Nrrd *nhisto);
/* tend{Flotsam,Anplot,Anvol,Evec,Eval,. . .}.c */
/* removed from below (superseded by estim): F(calc) \ */
extern const unrrduCmd *const tendCmdList[];
extern const hestCB *const tendFiberStopCB;
extern const char *const tendTitle;
