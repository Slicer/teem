...
_BIFF_DICT = {  # contents here are filled in by teem/python/cffi/exult.py Tffi.wrap()
    ...
    'nrrdKernelParse': (_equals_one, 0, b'nrrd', 'nrrd/kernel.c:2973'),
    'nrrdKernelSpecParse': (_equals_one, 0, b'nrrd', 'nrrd/kernel.c:3153'),
    'nrrdKernelSpecSprint': (_equals_one, 0, b'nrrd', 'nrrd/kernel.c:3175'),
    'nrrdKernelSprint': (_equals_one, 0, b'nrrd', 'nrrd/kernel.c:3230'),
    'nrrdKernelCompare': (_equals_one, 0, b'nrrd', 'nrrd/kernel.c:3248'),
    'nrrdKernelSpecCompare': (_equals_one, 0, b'nrrd', 'nrrd/kernel.c:3297'),
    'nrrdKernelCheck': (_equals_one, 0, b'nrrd', 'nrrd/kernel.c:3366'),
    ...
    'nrrdProject': (_equals_one, 0, b'nrrd', 'nrrd/measure.c:1132'),
    ...
    'meetNrrdKernelAllCheck': (_equals_one, 0, b'meet', 'meet/meetNrrd.c:232'),
