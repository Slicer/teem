...
_BIFF_DICT = {  # contents here are filled in by teem/python/cffi/exult.py Tffi.wrap()
    ...
    'nrrdResampleExecute': (_equals_one, 0, b'nrrd', 'nrrd/resampleContext.c:1455'),
    ...
    'tenEstimateUpdate': (_equals_one, 0, b'ten', 'ten/estimate.c:804'),
    'tenEstimate1TensorSimulateSingle_f': (_equals_one, 0, b'ten', 'ten/estimate.c:978'),
    'tenEstimate1TensorSimulateSingle_d': (_equals_one, 0, b'ten', 'ten/estimate.c:1006'),
    'tenEstimate1TensorSimulateVolume': (_equals_one, 0, b'ten', 'ten/estimate.c:1037'),
    'tenEstimate1TensorSingle_f': (_equals_one, 0, b'ten', 'ten/estimate.c:1742'),
    'tenEstimate1TensorSingle_d': (_equals_one, 0, b'ten', 'ten/estimate.c:1770'),
    'tenEstimate1TensorVolume4D': (_equals_one, 0, b'ten', 'ten/estimate.c:1807'),
    ...
    'pullPointInitializeGivenPos': (_equals_one, 0, b'pull', 'pull/pointPull.c:995'),
    ...
    'meetNrrdKernelAllCheck': (_equals_one, 0, b'meet', 'meet/meetNrrd.c:238'),
