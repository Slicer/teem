...
ELL_EXPORT const char *const ell_biff_key;
...
ELL_EXPORT double ell_3v_area_spherical_d(const double avec[3],
                                          const double bvec[3],
                                          const double cvec[3]);
ELL_EXPORT void ell_3v_barycentric_spherical_d(double bary[3],
                                               const double av[3],
                                               const double bv[3],
                                               const double cv[3],
                                               const double vv[3]);
...
ELL_EXPORT int ell_q_avg4_d(double m[4], unsigned int *iterP, const double _q1[4],
                            const double _q2[4], const double _q3[4],
                            const double _q4[4], const double _wght[4], const double eps,
                            const unsigned int maxIter);
ELL_EXPORT int ell_q_avgN_d(double mm[4], unsigned int *iterP, const double *qq,
...
ELL_EXPORT int ell_2m_eigensolve_d(double eval[2], double evec[4], const double m[4]);
...
ELL_EXPORT int ell_3m_eigensolve_d(double eval[3], double evec[9], const double m[9],
                                   const int newton);
