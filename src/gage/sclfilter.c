...
void
gageScl3PFilter2(gageShape *shape, double *ivX, double *ivY, double *ivZ, double *fw0,
                 double *fw1, double *fw2, double *val, double *gvec, double *hess,
                 const int *needD) {
  int doV, doD1, doD2;
  doV = needD[0];
  doD1 = needD[1];
...
void
gageScl3PFilter4(gageShape *shape, double *ivX, double *ivY, double *ivZ, double *fw0,
                 double *fw1, double *fw2, double *val, double *gvec, double *hess,
                 const int *needD) {
  int doV, doD1, doD2;
  doV = needD[0];
...
void
gageScl3PFilter6(gageShape *shape, double *ivX, double *ivY, double *ivZ, double *fw0,
                 double *fw1, double *fw2, double *val, double *gvec, double *hess,
                 const int *needD) {
  int i, j;
  double T;
...
void
gageScl3PFilter8(gageShape *shape, double *ivX, double *ivY, double *ivZ, double *fw0,
                 double *fw1, double *fw2, double *val, double *gvec, double *hess,
                 const int *needD) {
  int i, j;
  double T;
...
void
gageScl3PFilterN(gageShape *shape, int fd, double *ivX, double *ivY, double *ivZ,
                 double *fw0, double *fw1, double *fw2, double *val, double *gvec,
                 double *hess, const int *needD) {
  int i, j;
  double T;
  int doV, doD1, doD2;
  doV = needD[0];
...
_gageSclFilter(gageContext *ctx, gagePerVolume *pvl) {
  ...
  if (fd <= 8) {
    filter[ctx->radius](ctx->shape, pvl->iv3, pvl->iv2, pvl->iv1, fw00, fw11, fw22,
                        pvl->directAnswer[gageSclValue],
                        pvl->directAnswer[gageSclGradVec],
                        pvl->directAnswer[gageSclHessian], pvl->needD);
  } else {
    gageScl3PFilterN(ctx->shape, fd, pvl->iv3, pvl->iv2, pvl->iv1, fw00, fw11, fw22,
                     pvl->directAnswer[gageSclValue], pvl->directAnswer[gageSclGradVec],
                     pvl->directAnswer[gageSclHessian], pvl->needD);
  }
