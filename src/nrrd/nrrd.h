...
NRRD_EXPORT int nrrdWrap_nva(Nrrd *nrrd, void *data, int type, unsigned int dim,
                             const size_t *size);
...
NRRD_EXPORT int nrrdAxisInfoCopy(Nrrd *nout, const Nrrd *nin, const int *axmap,
                                 int excludeBitflag);
NRRD_EXPORT void nrrdAxisInfoSet_nva(Nrrd *nin, int axInfo, const void *info);
NRRD_EXPORT void nrrdAxisInfoSet_va(Nrrd *nin, int axInfo, ... /* const void* */);
...
NRRD_EXPORT void nrrdAxisInfoPosRange(double *loP, double *hiP, const Nrrd *nrrd,
                                      unsigned int ax, double loIdx, double hiIdx);
NRRD_EXPORT void nrrdAxisInfoIdxRange(double *loP, double *hiP, const Nrrd *nrrd,
...
NRRD_EXPORT unsigned int nrrdNonSpatialAxesGet(const Nrrd *nrrd,
                                               unsigned int axisIdx[NRRD_DIM_MAX]);
NRRD_EXPORT int nrrdSpacingCalculate(const Nrrd *nrrd, unsigned int ax, double *spacing,
                                     double vector[NRRD_SPACE_DIM_MAX]);
NRRD_EXPORT int nrrdOrientationReduce(Nrrd *nout, const Nrrd *nin,
                                      int setMinsFromOrigin);
/* ---- BEGIN non-NrrdIO */
NRRD_EXPORT int nrrdMetaDataNormalize(Nrrd *nout, const Nrrd *nin, int version,
...
NRRD_EXPORT int nrrdOriginCalculate(const Nrrd *nrrd, unsigned int *axisIdx,
                                    unsigned int axisIdxNum, int defaultCenter,
                                    double *origin);
NRRD_EXPORT int nrrdContentSet_va(Nrrd *nout, const char *func, const Nrrd *nin,
...
NRRD_EXPORT void nrrdKeyValueIndex(const Nrrd *nrrd, char **keyP, char **valueP,
                                   unsigned int ki);
...
/* ---- END non-NrrdIO */
NRRD_EXPORT size_t (*const nrrdStringValsParse[NRRD_TYPE_MAX + 1])(void *out,
                                                                   const char *s,
                                                                   const char *sep,
                                                                   size_t n);
...
NRRD_EXPORT int nrrdSaveMulti(const char *fnameFormat, const Nrrd *const *nin,
...
NRRD_EXPORT int nrrdShuffle(Nrrd *nout, const Nrrd *nin, unsigned int axis,
                            const size_t *perm);
/* ---- BEGIN non-NrrdIO */
NRRD_EXPORT int nrrdAxesSwap(Nrrd *nout, const Nrrd *nin, unsigned int ax1,
                             unsigned int ax2);
NRRD_EXPORT int nrrdFlip(Nrrd *nout, const Nrrd *nin, unsigned int axis);
NRRD_EXPORT int nrrdJoin(Nrrd *nout, const Nrrd *const *nin, unsigned int numNin,
...
NRRD_EXPORT int nrrdReshape_nva(Nrrd *nout, const Nrrd *nin, unsigned int dim,
                                const size_t *size);
...
NRRD_EXPORT int nrrdTile2D(Nrrd *nout, const Nrrd *nin, unsigned int ax0,
                           unsigned int ax1, unsigned int axSplit, size_t sizeFast,
                           size_t sizeSlow);
NRRD_EXPORT int nrrdUntile2D(Nrrd *nout, const Nrrd *nin, unsigned int ax0,
...
NRRD_EXPORT int nrrdRangePercentileFromStringSet(NrrdRange *range,
                                                 ...
                                                 unsigned int hbins,
                                                 int blind8BitRange);
NRRD_EXPORT void nrrdRangeSafeSet(NrrdRange *range, const Nrrd *nrrd,
                                  int blind8BitRange);
...
NRRD_EXPORT int nrrdCastClampRound(Nrrd *nout, const Nrrd *nin, int type, int doClamp,
                                   int roundDir);
NRRD_EXPORT int nrrdQuantize(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
                             unsigned int bits);
...
/* apply1D.c */
NRRD_EXPORT int nrrdApply1DLut(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
                               const Nrrd *nlut, int typeOut, int rescale);
NRRD_EXPORT int nrrdApplyMulti1DLut(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
                                    const Nrrd *nmlut, int typeOut, int rescale);
NRRD_EXPORT int nrrdApply1DRegMap(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
...
NRRD_EXPORT int nrrdApply1DIrregMap(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
...
/* apply2D.c */
NRRD_EXPORT int nrrdApply2DLut(Nrrd *nout, const Nrrd *nin, unsigned int domainAxis,
...
/* ---- BEGIN non-NrrdIO */
NRRD_EXPORT int nrrdSliceSelect(Nrrd *noutAbove, Nrrd *noutBelow, const Nrrd *nin,
...
NRRD_EXPORT int nrrdCropAuto(Nrrd *nout, const Nrrd *nin, size_t _min[NRRD_DIM_MAX],
...
NRRD_EXPORT int nrrdPad_nva(Nrrd *nout, const Nrrd *nin, const ptrdiff_t *min,
                            const ptrdiff_t *max, int boundary, double padValue);
NRRD_EXPORT int nrrdPad_va(Nrrd *nout, const Nrrd *nin, const ptrdiff_t *min,
                           const ptrdiff_t *max, int boundary,
                           ... /* double value (if nrrdBoundaryPad) */);
NRRD_EXPORT int nrrdSimplePad_nva(Nrrd *nout, const Nrrd *nin, unsigned int pad,
                                  int boundary, double padValue);
NRRD_EXPORT int nrrdSimplePad_va(Nrrd *nout, const Nrrd *nin, unsigned int pad,
                                 int boundary,
                                 ... /* double value (if nrrdBoundaryPad) */);
NRRD_EXPORT int nrrdInset(Nrrd *nout, const Nrrd *nin, const Nrrd *nsub,
                          const size_t *min);
...
NRRD_EXPORT int nrrdHistoDraw(Nrrd *nout, const Nrrd *nin, size_t sy, int showLog,
                              double max);
NRRD_EXPORT int nrrdHistoAxis(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
...
NRRD_EXPORT int nrrdArithGamma(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
                               double gamma);
NRRD_EXPORT int nrrdArithSRGBGamma(Nrrd *nout, const Nrrd *nin, const NrrdRange *range,
                                   int forward);
NRRD_EXPORT int nrrdArithUnaryOp(Nrrd *nout, int op, const Nrrd *nin);
NRRD_EXPORT int nrrdArithBinaryOp(Nrrd *nout, int op, const Nrrd *ninA,
                                  const Nrrd *ninB);
NRRD_EXPORT int nrrdArithTernaryOp(Nrrd *nout, int op, const Nrrd *ninA,
                                   const Nrrd *ninB, const Nrrd *ninC);
NRRD_EXPORT int nrrdArithAffine(Nrrd *nout, double minIn, const Nrrd *nin, double maxIn,
                                double minOut, double maxOut, int clamp);
NRRD_EXPORT int nrrdArithIterBinaryOp(Nrrd *nout, int op, NrrdIter *inA, NrrdIter *inB);
NRRD_EXPORT int nrrdArithIterBinaryOpSelect(Nrrd *nout, int op, NrrdIter *inA,
                                            NrrdIter *inB, unsigned int which);
NRRD_EXPORT int nrrdArithIterTernaryOp(Nrrd *nout, int op, NrrdIter *inA, NrrdIter *inB,
                                       NrrdIter *inC);
NRRD_EXPORT int nrrdArithIterTernaryOpSelect(Nrrd *nout, int op, NrrdIter *inA,
                                             NrrdIter *inB, NrrdIter *inC,
                                             unsigned int which);
NRRD_EXPORT int nrrdArithIterAffine(Nrrd *nout, NrrdIter *minIn, NrrdIter *in,
...
/* filt.c */
NRRD_EXPORT int nrrdCheapMedian(Nrrd *nout, const Nrrd *nin, int pad, int mode,
                                unsigned int radius, float wght, unsigned int bins);
NRRD_EXPORT int nrrdDistanceL2(Nrrd *nout, const Nrrd *nin, int typeOut,
                               const int *axisDo, double thresh, int insideHigher);
NRRD_EXPORT int nrrdDistanceL2Biased(Nrrd *nout, const Nrrd *nin, int typeOut,
                                     const int *axisDo, double thresh, double bias,
                                     int insideHigher);
NRRD_EXPORT int nrrdDistanceL2Signed(Nrrd *nout, const Nrrd *nin, int typeOut,
                                     const int *axisDo, double thresh, int insideHigher);
...
NRRD_EXPORT int nrrdDeringVerticalSeamSet(NrrdDeringContext *drc, int vertSeam);
NRRD_EXPORT int nrrdDeringInputSet(NrrdDeringContext *drc, const Nrrd *nin);
NRRD_EXPORT int nrrdDeringCenterSet(NrrdDeringContext *drc, double cx, double cy);
NRRD_EXPORT int nrrdDeringClampPercSet(NrrdDeringContext *drc, double lo, double hi);
NRRD_EXPORT int nrrdDeringClampHistoBinsSet(NrrdDeringContext *drc, unsigned int bins);
NRRD_EXPORT int nrrdDeringRadiusScaleSet(NrrdDeringContext *drc, double rsc);
NRRD_EXPORT int nrrdDeringThetaNumSet(NrrdDeringContext *drc, unsigned int thetaNum);
...
NRRD_EXPORT int nrrdResampleNonExistentSet(NrrdResampleContext *rsmc, int nonExistent);
NRRD_EXPORT int nrrdResampleNrrdSet(NrrdResampleContext *rsmc, const Nrrd *nin);
NRRD_EXPORT int nrrdResampleInputSet(NrrdResampleContext *rsmc, const Nrrd *nin);
...
NRRD_EXPORT int nrrdResampleSamplesSet(NrrdResampleContext *rsmc,
                                       unsigned int axIdx,
                                       size_t samples);
NRRD_EXPORT int nrrdResampleRangeSet(NrrdResampleContext *rsmc, unsigned int axIdx,
...
NRRD_EXPORT int nrrdSimpleResample(Nrrd *nout, const Nrrd *nin, const NrrdKernel *kernel,
...
/* cc.c */
NRRD_EXPORT int nrrdCCFind(Nrrd *nout, Nrrd **nvalP, const Nrrd *nin, int type,
                           unsigned int conny);
NRRD_EXPORT int nrrdCCAdjacency(Nrrd *nout, const Nrrd *nin, unsigned int conny);
NRRD_EXPORT int nrrdCCMerge(Nrrd *nout, const Nrrd *nin, Nrrd *nval, int dir,
...
NRRD_EXPORT int nrrdFFT(Nrrd *nout, const Nrrd *nin, unsigned int *axes,
...
NRRD_EXPORT const NrrdKernel *nrrdKernelDerivative(const NrrdKernel *kern);
/* ---- END non-NrrdIO */
