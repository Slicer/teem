...
main(int argc, char *argv[]) {
  ...
  printf("min, max = %lg, %lg\n", nrrd->axis[0].min, nrrd->axis[0].max);
  printf("pos, pos2 = %lg, %lg\n", pos, pos2);
  printf("idx, idx2 = %lg, %lg\n", idx, idx2);
  printf("pos3, pos4 = %lg, %lg\n", pos3, pos4);
  exit(1);
