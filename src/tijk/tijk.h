...
TIJK_EXPORT void tijk_add_d(double *res, const double *A, const double *B,
                            const tijk_type *type);
TIJK_EXPORT void tijk_add_f(float *res, const float *A, const float *B,
                            const tijk_type *type);

TIJK_EXPORT void tijk_sub_d(double *res, const double *A, const double *B,
                            const tijk_type *type);
TIJK_EXPORT void tijk_sub_f(float *res, const float *A, const float *B,
                            const tijk_type *type);

TIJK_EXPORT void tijk_incr_d(double *res, const double *A, const tijk_type *type);
TIJK_EXPORT void tijk_incr_f(float *res, const float *A, const tijk_type *type);

TIJK_EXPORT void tijk_negate_d(double *res, const double *A, const tijk_type *type);
TIJK_EXPORT void tijk_negate_f(float *res, const float *A, const tijk_type *type);
...
TIJK_EXPORT void tijk_copy_d(double *res, const double *A, const tijk_type *type);
TIJK_EXPORT void tijk_copy_f(float *res, const float *A, const tijk_type *type);
...
TIJK_EXPORT tijk_refine_rank1_parm *tijk_refine_rank1_parm_nix(tijk_refine_rank1_parm
                                                                 *parm);
...
TIJK_EXPORT tijk_refine_rankk_parm *tijk_refine_rankk_parm_nix(tijk_refine_rankk_parm
                                                                 *parm);
...
TIJK_EXPORT tijk_approx_heur_parm *tijk_approx_heur_parm_nix(tijk_approx_heur_parm
                                                               *parm);
...
TIJK_EXPORT int tijk_refine_rankk_2d_d(double *ls, double *vs, double *tens, double *res,
                                       double *resnorm, const double orignorm,
                                       const tijk_type *type, const unsigned int k,
                                       const tijk_refine_rankk_parm *parm);
TIJK_EXPORT int tijk_refine_rankk_2d_f(float *ls, float *vs, float *tens, float *res,
                                       float *resnorm, const float orignorm,
                                       const tijk_type *type, const unsigned int k,
                                       const tijk_refine_rankk_parm *parm);
TIJK_EXPORT int tijk_refine_rankk_3d_d(double *ls, double *vs, double *tens, double *res,
                                       double *resnorm, const double orignorm,
                                       const tijk_type *type, const unsigned int k,
                                       const tijk_refine_rankk_parm *parm);
TIJK_EXPORT int tijk_refine_rankk_3d_f(float *ls, float *vs, float *tens, float *res,
                                       float *resnorm, const float orignorm,
                                       const tijk_type *type, const unsigned int k,
                                       const tijk_refine_rankk_parm *parm);
...
TIJK_EXPORT int tijk_approx_heur_2d_f(float *ls, float *vs, float *res, const float *ten,
                                      const tijk_type *type, const unsigned int k,
                                      const tijk_approx_heur_parm *parm);
TIJK_EXPORT int tijk_approx_heur_3d_d(double *ls, double *vs, double *res,
                                      ...
                                      const unsigned int k,
                                      const tijk_approx_heur_parm *parm);
TIJK_EXPORT int tijk_approx_heur_3d_f(float *ls, float *vs, float *res, const float *ten,
                                      const tijk_type *type, const unsigned int k,
                                      const tijk_approx_heur_parm *parm);
...
TIJK_EXPORT double tijk_eval_esh_d(double *coeffs, unsigned int order, double theta,
                                   double phi);
TIJK_EXPORT float tijk_eval_esh_f(float *coeffs, unsigned int order, float theta,
                                  float phi);
...
TIJK_EXPORT void tijk_esh_convolve_d(double *out, const double *in, const double *kernel,
                                     unsigned int order);
TIJK_EXPORT void tijk_esh_convolve_f(float *out, const float *in, const float *kernel,
                                     unsigned int order);

TIJK_EXPORT void tijk_esh_deconvolve_d(double *out, const double *in,
                                       const double *kernel, unsigned int order);
TIJK_EXPORT void tijk_esh_deconvolve_f(float *out, const float *in, const float *kernel,
                                       unsigned int order);
...
TIJK_EXPORT double tijk_eval_efs_d(double *coeffs, unsigned int order, double phi);
TIJK_EXPORT float tijk_eval_efs_f(float *coeffs, unsigned int order, float phi);
...
TIJK_EXPORT int tijk_set_axis_esh(Nrrd *nrrd, unsigned int axis, unsigned int order);

TIJK_EXPORT int tijk_set_axis_efs(Nrrd *nrrd, unsigned int axis, unsigned int order);
...
TIJK_EXPORT int tijk_get_axis_type(tijk_axis_info *info, const Nrrd *nrrd,
                                   unsigned int axis);
