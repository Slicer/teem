...
unrrdu_aboutMain(int argc, const char **argv, const char *me, hestParm *hparm) {
  ...
  char par3[] = "\t\t\t\t"
                ...
                "(e.g. \"unu slice\"), or with \"--help\" as one of its arguments, "
                "generates its description and detailed usage information. "
                "This includes information (marked with \"* Uses ...\") "
                "about the underling Nrrd library function calls "
                "(e.g. \"unu slice\" is implemented with nrrdSlice()).\n ";
  char par4[] = "\t\t\t\t"
