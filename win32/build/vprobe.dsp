...
# ADD LINK32 /libpath:"../lib/static" teem_d.lib png.lib bz2.lib z.lib /nologo /subsystem:console /incremental:no /debug /machine:I386 /pdbtype:sept /out:../bin/vprobe_d.exe
# Begin Special Build Tool
TargetName=vprobe_d
SOURCE="$(InputPath)"
# End Special Build Tool
